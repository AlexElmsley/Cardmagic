...
deckout = deckinsert(deck,where=[]; errormargin=0);
...
function deckinsert(packet,deck,where=[]; errormargin=0);
...
#@show indexout1,indexout2,packet
#return deck[indexout]
return (deck[indexout1]...,packet...,deck[indexout2]...)
